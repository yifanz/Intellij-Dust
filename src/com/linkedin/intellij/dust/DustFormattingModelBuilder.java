...
import com.linkedin.intellij.dust.config.DustConfig;
...
public class DustFormattingModelBuilder extends TemplateLanguageFormattingModelBuilder {
  ...
  public FormattingModel createModel(PsiElement element, CodeStyleSettings settings) {
    ...
    if (!DustConfig.isFormattingEnabled()) {
    ...
    if (node.getElementType() == DustTokenTypes.OUTER_ELEMENT_TYPE) {
  ...
  private static class HandlebarsBlock extends TemplateLanguageBlock {
     ...
     * root "program" element.  See {@link com.linkedin.intellij.dust.parsing.DustParsing#parseProgram} and
     * {@link com.linkedin.intellij.dust.parsing.DustParsing#parseStatement(com.intellij.lang.PsiBuilder)} for the
    ...
    public ChildAttributes getChildAttributes(int newChildIndex) {
       ...
       */
      if (myNode.getElementType() == DustTokenTypes.BLOCK_WRAPPER
          ...
          &&
          (myNode.getElementType() != DustTokenTypes.STATEMENTS || myNode.getTreeNext() instanceof PsiErrorElement))) {
